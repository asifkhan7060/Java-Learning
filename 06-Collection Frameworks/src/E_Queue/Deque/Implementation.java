...
public class Implementation {
    ...
    public static void main(String[] args) {
        ...
        linkedListDeque.add(100);
        linkedListDeque.add(200);
        linkedListDeque.add(300);
        ...
        Deque<Integer> blockingDeque =
                new LinkedBlockingDeque<>();

        blockingDeque.add(1000);
        blockingDeque.add(2000);
        blockingDeque.add(3000);
        ...
        /*
            ...
            3. ArrayDeque is generally
               preferred over Stack.

            4. Most Deque implementations
               do not allow null values.

            5. LinkedList implements
               both List and Deque.

            6. BlockingDeque extends
               Deque for concurrent programming.
         */
        ...
        /*
            ...
            ✔ Use push() and pop()
              for Stack (LIFO) behavior.

            ✔ Use LinkedBlockingDeque
              only when thread safety
              is required.
         */
